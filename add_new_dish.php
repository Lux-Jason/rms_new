...
<div class="main-container">
    <div class="add_item_admin-container">
        ...
        <form action="additem_sql_op.php" method="post">
            ...
            <textarea name="ingredient" placeholder="Input Ingredient" id="ingredient" onfocus="inputFocus(this)" required></textarea>
            <textarea name="description" placeholder="Input Description" id="description" onfocus="inputFocus(this)" required></textarea>
